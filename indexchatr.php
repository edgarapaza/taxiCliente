...
include("Model/chat.model.php");
    ...
    $datoCliente = $datoscliente->Datos($idcliente);
    
    $_SESSION['myidcliente'] = $idcliente;
    $_SESSION['myidconductor'] = $idconductor;
    $_SESSION['myidreserva'] = $idpedidoRes;



$chatboot = new ChatBoot();

$data = $chatboot->MostrarChat($idconductor, $idpedidoRes, $idcliente);
...
if(isset($_POST['enviar']))
{
	if(!empty($_POST['nombre']) && !empty($_POST['mensaje']))
	{
		...
		$res = $chatboot->GuardarChatReserva($nombre,$mensaje,$idcliente,$idconductor,$idpedidoRes);
...
<body onload="ajax();">
	      	...
	      	<ul id="slide-out" class="sidenav">
	        	<li>
	        		<div class="user-view">
			          ...
			          <a href="#name"><span class="white-text name"><?php echo $datoCliente['nombres']; ?></span></a>
			          <a href="#email"><span class="white-text email">Telefono: <?php echo $datoCliente['telefono']; ?></span></a>
			      	</div>
			    </li>
		        <li><a href="indexchat.php?idcliente=<?php echo $idcliente;?>"><i class="material-icons">cloud</i>Mostrar chat</a></li>
		        <li><a href="pedirMovilidad.php?idcliente=<?php echo $idcliente;?>">Solicitar Movilidad</a></li>
		        <li><a href="pedirDelivery.php?idcliente=<?php echo $idcliente;?>">Pedir Devilevry</a></li>
	...
	<a href="menu.php?idcliente=<?php echo $idcliente;?>" title="#" class="btn blue" id="">Regresar al Menu</a> 
	
	<a href="chatReserva.php?idcliente=<?php echo $idcliente;?>&idpedidoRes=<?php echo $idpedidoRes;?>&idconductor=<?php echo $idconductor;?>" title="#" class="btn red" id="">Lista de Conversaciones</a>
	...
	<div id="contenedor">
		...
		<form action="" method="post" id="chat-form">
			...
			<input type="hidden" name="idpedidoRes" value="<?php echo $idpedidoRes; ?>">
			<input type="hidden" name="nombre" value="<?php echo $datoCliente['nombres']; ?>">
