...
if(!empty($_SESSION['idcliente'])){
    ...
    if(isset($_POST['enviar']))
    {
    	if(!empty($_POST['nombre']) && !empty($_POST['mensaje']))
    	{
    		...
    		$res = $chatboot->GuardarChatDelivery($nombre,$mensaje,$idcliente,$idconductor,$idpedidoDeli);
...
<body onload="ajax();">
	...
	<a href="chatDelivery.php?idcliente=<?php echo $idcliente;?>&idpedidoDeli=<?php echo $idpedidoDeli;?>&idconductor=<?php echo $idconductor;?>" title="#" class="btn red" id="">Lista de Conversaciones</a>
	...
	<div id="contenedor">
		...
		<form action="" method="post" id="chat-form">
			...
			<input type="hidden" name="idpedidoDeli" value="<?php echo $idpedidoDeli; ?>">
